...
def convert_megatron_checkpoint(args, input_state_dict, config):
    ...
    if hyper_params is not None:    
        ...
        config.n_positions = hyper_params["cfg"]["max_position_embeddings"]
        config.n_embd = hyper_params["cfg"]["hidden_size"]
        config.n_layer = hyper_params["cfg"]["num_layers"]
        config.n_head = hyper_params["cfg"]["num_attention_heads"]
        config.n_inner = hyper_params["cfg"]["ffn_hidden_size"]
    ...
    pos_embeddings = state_dict["model.language_model.embedding.position_embeddings.weight"]
    ...
    # The final layernorm.
    output_state_dict["transformer.ln_f.weight"] = state_dict["model.language_model.encoder.final_layernorm.weight"]
    output_state_dict["transformer.ln_f.bias"] = state_dict["model.language_model.encoder.final_layernorm.bias"]
